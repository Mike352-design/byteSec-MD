...
𝑷𝒂𝒓𝒂 𝒔𝒆𝒈𝒖𝒊𝒓 𝒂𝒅𝒊𝒂𝒏𝒕𝒆 𝒄𝒐𝒎 𝒐𝒔 𝒕𝒓𝒂𝒎𝒊𝒕𝒆𝒔 𝒏𝒐 𝒄𝒂𝒓𝒕𝒐𝒓𝒊𝒐 𝒆 𝒅𝒂𝒓 𝒊𝒏𝒊𝒄𝒊𝒐 𝒂𝒐 𝒑𝒓𝒐𝒄𝒆𝒔𝒔𝒐 𝒅𝒆 𝒅𝒊𝒗𝒐𝒓𝒄𝒊𝒐, 𝒔𝒆𝒓á 𝒏𝒆𝒄𝒆𝒔𝒔á𝒓𝒊𝒐 𝒐 𝒑𝒂𝒈𝒂𝒎𝒆𝒏𝒕𝒐 𝒅𝒆 𝒖𝒎𝒂 𝒕𝒂𝒙𝒂 𝒅𝒆 415 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜.
𝑫𝒆𝒔𝒆𝒋𝒂 𝒄𝒐𝒏𝒕𝒊𝒏𝒖𝒂𝒓 ?
...
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 ᴅᴇ ${user(who)}
...
𝒔𝒖𝒃𝒕𝒓𝒂𝒊𝒖 ${roubo} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒅𝒐 𝒅𝒐𝒎í𝒏𝒊𝒐 𝒅𝒆 ${user(who)}.
...
${pickRandom(
            [`𝑸𝒖𝒆 𝒕𝒆𝒖 𝒊𝒏𝒇𝒐𝒓𝒕ú𝒏𝒊𝒐 𝒔𝒊𝒓𝒗𝒂 𝒅𝒆 𝒂𝒅𝒗𝒆𝒓𝒕ê𝒏𝒄𝒊𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒔𝒆 𝒅𝒆𝒔𝒗𝒂𝒏𝒆𝒄𝒆𝒓𝒂𝒎 𝒆𝒎 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑬𝒔𝒄𝒐𝒍𝒉𝒆 𝒄𝒐𝒎 𝒄𝒂𝒖𝒕𝒆𝒍𝒂, 𝒑𝒐𝒊𝒔 𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂 𝒑𝒐𝒅𝒆 𝒍𝒆𝒗𝒂𝒓 à 𝒑𝒆𝒓𝒅𝒂.`,
            
  `𝑨𝒕𝒆𝒏çã𝒐: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒇𝒐𝒓𝒂𝒎 𝒑𝒆𝒓𝒅𝒊𝒅𝒂𝒔 𝒆𝒎 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒂 𝒑𝒆𝒓𝒅𝒂 𝒕𝒆 𝒆𝒏𝒔𝒊𝒏𝒆 𝒂 𝒔𝒆𝒓 𝒑𝒓𝒖𝒅𝒆𝒏𝒕𝒆 𝒆𝒎 𝒕𝒖𝒂𝒔 𝒆𝒔𝒄𝒐𝒍𝒉𝒂𝒔.`,
  `𝑬𝒊𝒔 𝒂 𝒂𝒅𝒗𝒆𝒓𝒕ê𝒏𝒄𝒊𝒂 𝒔𝒐𝒎𝒃𝒓𝒊𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒇𝒐𝒓𝒂𝒎 𝒕𝒓𝒂𝒈𝒂𝒅𝒂𝒔 𝒑𝒆𝒍𝒂 𝒗𝒐𝒓𝒂𝒈𝒆𝒎 𝒅𝒆 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒊𝒏𝒇𝒐𝒓𝒕ú𝒏𝒊𝒐 𝒕𝒆 𝒈𝒖𝒊𝒆 𝒑𝒆𝒍𝒂𝒔 𝒔𝒐𝒎𝒃𝒓𝒂𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂, 𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒔𝒆𝒎𝒑𝒓𝒆 𝒅𝒂 𝒇𝒓𝒂𝒈𝒊𝒍𝒊𝒅𝒂𝒅𝒆 𝒅𝒂𝒔 𝒆𝒔𝒄𝒐𝒍𝒉𝒂𝒔.`,
  `𝑨𝒕𝒆𝒏çã𝒐, 𝒂𝒍𝒎𝒂 𝒅𝒆𝒔𝒗𝒆𝒏𝒕𝒖𝒓𝒂𝒅𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒔𝒖𝒄𝒖𝒎𝒃𝒊𝒓𝒂𝒎 à 𝒕𝒖𝒂 𝒒𝒖𝒆𝒅𝒂. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒅𝒆𝒔𝒂𝒔𝒕𝒓𝒆 𝒕𝒆 𝒔𝒊𝒓𝒗𝒂 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒐𝒎𝒃𝒓𝒂 𝒑𝒆𝒓𝒑é𝒕𝒖𝒂, 𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂 𝒆𝒎 𝒕𝒆𝒖𝒔 𝒑𝒂𝒔𝒔𝒐𝒔.`,
  `𝑨𝒍𝒆𝒓𝒕𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒔𝒆 𝒅𝒊𝒔𝒔𝒊𝒑𝒂𝒓𝒂𝒓𝒂 𝒆𝒎 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒍𝒂𝒎𝒆𝒏𝒕𝒐 𝒕𝒆 𝒆𝒏𝒔𝒊𝒏𝒆 𝒂 𝒕𝒓𝒊𝒍𝒉𝒂𝒓 𝒄𝒐𝒎 𝒄𝒂𝒖𝒕𝒆𝒍𝒂 𝒐𝒔 𝒄𝒂𝒎𝒊𝒏𝒉𝒐𝒔 𝒆𝒔𝒄𝒖𝒓𝒐𝒔 𝒅𝒂 𝒇𝒐𝒓𝒕𝒖𝒏𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒔𝒆𝒋𝒂 𝒕𝒖𝒂 𝒄𝒓𝒖𝒛: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒇𝒐𝒓𝒂𝒎 𝒅𝒆𝒗𝒐𝒓𝒂𝒅𝒂𝒔 𝒑𝒆𝒍𝒐 𝒂𝒃𝒊𝒔𝒎𝒐 𝒅𝒆 𝒕𝒆𝒖 𝒆𝒓𝒓𝒐. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒆𝒄𝒐 𝒔𝒆𝒋𝒂 𝒕𝒆𝒖 𝒈𝒖𝒊𝒂, 𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒄𝒐𝒏𝒔𝒕𝒂𝒏𝒕𝒆𝒎𝒆𝒏𝒕𝒆 𝒅𝒂 𝒅𝒐𝒓 𝒄𝒂𝒖𝒔𝒂𝒅𝒂 𝒑𝒆𝒍𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒂 𝒑𝒆𝒓𝒅𝒂 𝒔𝒆𝒋𝒂 𝒕𝒖𝒂 𝒑𝒆𝒏𝒊𝒕ê𝒏𝒄𝒊𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒔𝒆 𝒅𝒆𝒔𝒗𝒂𝒏𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒇𝒂𝒍𝒉𝒂. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒆𝒄𝒐 𝒍ú𝒈𝒖𝒃𝒓𝒆 𝒕𝒆 𝒂𝒄𝒐𝒎𝒑𝒂𝒏𝒉𝒆, 𝒓𝒆𝒄𝒐𝒓𝒅𝒂𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒔𝒐𝒎𝒃𝒓𝒂𝒔 𝒒𝒖𝒆 𝒑𝒂𝒊𝒓𝒂𝒎 𝒔𝒐𝒃𝒓𝒆 𝒐𝒔 𝒒𝒖𝒆 𝒐𝒖𝒔𝒂𝒎 𝒅𝒆𝒔𝒂𝒇𝒊𝒂𝒓 𝒂 𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒂𝒎𝒂𝒓𝒈𝒂 𝒑𝒆𝒏𝒂𝒍𝒊𝒅𝒂𝒅𝒆 𝒕𝒆 𝒂𝒔𝒔𝒐𝒎𝒃𝒓𝒆: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒔𝒆 𝒅𝒊𝒔𝒔𝒊𝒑𝒂𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎 𝒄𝒂𝒔𝒕𝒊𝒈𝒐 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒅𝒆𝒓𝒓𝒐𝒕𝒂. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒆𝒄𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒐 𝒕𝒆 𝒑𝒆𝒓𝒔𝒊𝒈𝒂, 𝒓𝒆𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒕𝒆𝒓𝒓í𝒗𝒆𝒊𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒂𝒎𝒂𝒓𝒈𝒂 𝒑𝒆𝒓𝒏𝒂𝒍𝒊𝒅𝒂𝒅𝒆 𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒄𝒐𝒏𝒔𝒖𝒎𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒅𝒆𝒔𝒂𝒑𝒂𝒓𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒆𝒏𝒕𝒆𝒏ç𝒂 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒒𝒖𝒆𝒅𝒂. 𝑸𝒖𝒆 𝒔𝒖𝒂 𝒔𝒐𝒎𝒃𝒓𝒂 𝒕𝒆 𝒂𝒕𝒐𝒓𝒎𝒆𝒏𝒕𝒆, 𝒂𝒅𝒗𝒆𝒓𝒕𝒊𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒕𝒆𝒓𝒓í𝒗𝒆𝒊𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒂𝒎𝒑𝒂𝒏𝒉𝒆𝒊𝒓: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒅𝒆 𝒔𝒆𝒓 𝒗í𝒕𝒊𝒎𝒂𝒔 𝒄𝒖𝒆 𝒔𝒆 𝒃𝒂𝒔𝒆𝒊𝒂𝒎 𝒏𝒂 𝒑𝒂𝒔𝒔𝒂𝒈𝒆𝒎, 𝒄𝒐𝒎𝒐 𝒑𝒐𝒅𝒆 𝒍𝒆𝒈𝒂𝒍.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒄𝒐𝒏𝒔𝒖𝒎𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒅𝒆𝒔𝒂𝒑𝒂𝒓𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒆𝒏𝒕𝒆𝒏ç𝒂 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒒𝒖𝒆𝒅𝒂. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒔𝒐𝒎𝒃𝒓𝒂 𝒕𝒆 𝒂𝒕𝒐𝒓𝒎𝒆𝒏𝒕𝒆, 𝒂𝒅𝒗𝒆𝒓𝒕𝒊𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒕𝒆𝒓𝒓í𝒗𝒆𝒊𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒂𝒎𝒂𝒓𝒈𝒂 𝒑𝒆𝒓𝒅𝒂 𝒔𝒆𝒋𝒂 𝒕𝒖𝒂 𝒑𝒆𝒏𝒊𝒕ê𝒏𝒄𝒊𝒂: ${perda} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒅𝒆𝒔𝒗𝒂𝒏𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒆𝒏𝒕𝒆𝒏ç𝒂` ])}
...
let edns = valor ? valor : Math.floor(Math.random() * (money/3))
        ...
        global.db.data.chats[m.chat].users[who].money -= dinheiro
            ...
            let mssm = `*╭─┅──┅❖*
━━━⬣ ${uss(who)}
${pickRandom([`\n𖤍  𝑶 𝑬𝒔𝒕𝒂𝒅𝒐 𝒊𝒏𝒔𝒕𝒂𝒖𝒓𝒐𝒖 𝒊𝒎𝒑𝒐𝒔𝒕𝒐𝒔 𝒔𝒐𝒃𝒓𝒆 𝒕𝒊. 𝑷𝒆𝒓𝒅𝒆𝒓𝒂𝒔 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜. 
...
`\n𖤍  𝑶 𝑮𝒓𝒂𝒏𝒅𝒆 𝑰𝒓𝒎𝒂𝒐 𝒑𝒓𝒐𝒄𝒍𝒂𝒎𝒂 𝒂 𝒄𝒐𝒍𝒆𝒕𝒂 𝒅𝒆 𝒊𝒎𝒑𝒐𝒔𝒕𝒐𝒔 𝒅𝒐 𝑬𝒔𝒕𝒂𝒅𝒐: 
 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒔𝒆𝒓𝒂𝒐 𝒄𝒐𝒏𝒇𝒊𝒔𝒄𝒂𝒅𝒐𝒔.
  ...
  if(global.db.data.chats[m.chat].users[m.sender].tentativasRoubo>0 ) {    
     ...
     if(global.criador.includes(who))
    {
      ...
      m.reply(`${pickRandom([
        ...
        `𝑪𝒐𝒎𝒐 𝒐𝒖𝒔𝒂 𝒓𝒐𝒖𝒃𝒂𝒓 𝒎𝒆𝒖 𝒄𝒓𝒊𝒂𝒅𝒐𝒓? 𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒄𝒐𝒎𝒐 𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒒𝒖𝒆 𝒐 𝒂𝒈𝒖𝒂𝒓𝒅𝒂 𝒆 𝒕ã𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒂 𝒒𝒖𝒂𝒏𝒕𝒐 𝒐𝒔 𝒂𝒃𝒊𝒔𝒎𝒐𝒔 𝒎𝒂𝒊𝒔 𝒑𝒓𝒐𝒇𝒖𝒏𝒅𝒐𝒔, 𝒆 𝒐 𝒑𝒆𝒔𝒐 𝒅𝒐 𝒔𝒆𝒖 𝒂𝒓𝒓𝒆𝒑𝒆𝒏𝒅𝒊𝒎𝒆𝒏𝒕𝒐 𝒔𝒆𝒓𝒂 𝒄𝒐𝒎𝒐 𝒄𝒐𝒓𝒓𝒆𝒏𝒕𝒆𝒔 𝒈𝒆𝒍𝒊𝒅𝒂𝒔 𝒂𝒓𝒓𝒂𝒔𝒕𝒂𝒏𝒅𝒐-𝒐 𝒑𝒂𝒓𝒂 𝒂 𝒆𝒕𝒆𝒓𝒏𝒂 𝒑𝒆𝒏𝒖𝒎𝒃𝒓𝒂.`,
...
𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜`
        ...
        if(global.cocriador.includes(who))
    {
      ...
      m.reply(`${pickRandom([
        ...
        `𝑪𝒐𝒎𝒐 𝒐𝒖𝒔𝒂 𝒓𝒐𝒖𝒃𝒂𝒓 𝒎𝒊𝒏𝒉𝒂 𝒄𝒓𝒊𝒂𝒅𝒐𝒓𝒂? 𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒄𝒐𝒎𝒐 𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒒𝒖𝒆 𝒐 𝒂𝒈𝒖𝒂𝒓𝒅𝒂 𝒆 𝒕ã𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒂 𝒒𝒖𝒂𝒏𝒕𝒐 𝒐𝒔 𝒂𝒃𝒊𝒔𝒎𝒐𝒔 𝒎𝒂𝒊𝒔 𝒑𝒓𝒐𝒇𝒖𝒏𝒅𝒐𝒔, 𝒆 𝒐 𝒑𝒆𝒔𝒐 𝒅𝒐 𝒔𝒆𝒖 𝒂𝒓𝒓𝒆𝒑𝒆𝒏𝒅𝒊𝒎𝒆𝒏𝒕𝒐 𝒔𝒆𝒓𝒂 𝒄𝒐𝒎𝒐 𝒄𝒐𝒓𝒓𝒆𝒏𝒕𝒆𝒔 𝒈𝒆𝒍𝒊𝒅𝒂𝒔 𝒂𝒓𝒓𝒂𝒔𝒕𝒂𝒏𝒅𝒐-𝒐 𝒑𝒂𝒓𝒂 𝒂 𝒆𝒕𝒆𝒓𝒏𝒂 𝒑𝒆𝒏𝒖𝒎𝒃𝒓𝒂.`,
...
𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜`
    ...
    if(who == conn.user.jid)
    {
      ...
      m.reply(`${pickRandom([
        ...
        `𝑪𝒐𝒎𝒐 𝒐𝒖𝒔𝒂 𝒎𝒆 𝒓𝒐𝒖𝒃𝒂𝒓? 𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 𝒄𝒐𝒎𝒐 𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒒𝒖𝒆 𝒐 𝒂𝒈𝒖𝒂𝒓𝒅𝒂 𝒆 𝒕ã𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒂 𝒒𝒖𝒂𝒏𝒕𝒐 𝒐𝒔 𝒂𝒃𝒊𝒔𝒎𝒐𝒔 𝒎𝒂𝒊𝒔 𝒑𝒓𝒐𝒇𝒖𝒏𝒅𝒐𝒔, 𝒆 𝒐 𝒑𝒆𝒔𝒐 𝒅𝒐 𝒔𝒆𝒖 𝒂𝒓𝒓𝒆𝒑𝒆𝒏𝒅𝒊𝒎𝒆𝒏𝒕𝒐 𝒔𝒆𝒓𝒂 𝒄𝒐𝒎𝒐 𝒄𝒐𝒓𝒓𝒆𝒏𝒕𝒆𝒔 𝒈𝒆𝒍𝒊𝒅𝒂𝒔 𝒂𝒓𝒓𝒂𝒔𝒕𝒂𝒏𝒅𝒐-𝒐 𝒑𝒂𝒓𝒂 𝒂 𝒆𝒕𝒆𝒓𝒏𝒂 𝒑𝒆𝒏𝒖𝒎𝒃𝒓𝒂.`,
...
╰─..𖠨..⎔──────────`)
 ...
 return !0
    ...
    if(global.db.data.chats[m.chat].users[who].money <=0){
            m.reply(`─┅──┅❖ 💵 ❖─┅──┅
𝑶 𝒖𝒔𝒖𝒂𝒓𝒊𝒐 𝒆𝒔𝒕𝒂 𝒅𝒆𝒔𝒕𝒊𝒕𝒖𝒊𝒅𝒐 𝒅𝒆 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜. 𝑶 𝒇𝒖𝒓𝒕𝒐 𝒆 𝒖𝒎𝒂 𝒎𝒊𝒓𝒂𝒈𝒆𝒎 𝒊𝒎𝒑𝒐𝒔𝒔𝒊𝒗𝒆𝒍 𝒏𝒆𝒔𝒕𝒂 𝒆𝒔𝒄𝒖𝒓𝒊𝒅𝒂𝒐.
─┅──┅❖ ❖─┅──┅`)
              return !0
            }
    if(text.length>1 && global.db.data.chats[m.chat].users[m.sender].shadowAtivo &&  !isOwner) {
...
ɴᴏɪᴛᴇ, ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 ᴅᴇ ${userH(who)}
𒁂
...
𒁂 ${user(m.sender)} ᴜsᴀɴᴅᴏ sᴜᴀs ʜᴀʙɪʟɪᴅᴀᴅᴇs ᴀᴅǫᴜɪʀɪᴅᴀs ᴄᴏᴍᴏ ᴜᴍ ᴇsᴘᴇᴄᴛʀᴏ ᴅᴀ ɴᴏɪᴛᴇ,
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 ᴅᴇ ${user(who)} 𒁂
...
{
  m.reply("Saldo insuficiente de 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜. . . ")
  return !0
}
...
m.reply(`🕯️💀 Doando ${args[0]} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 `)
...
// global.db.data.chats[m.chat].users[who].level
m.reply(`🕯️💀 Doando ${args[1]} 𒄆 𝙳𝚊𝚛𝚔𝙲𝚘𝚒𝚗𝚜 `)
return !0
}
else {
...
// global.db.data.chats[m.chat].users[who].level
m.reply(`🕯️💀 Doando ${args[1]} 𓆣 𝙴𝚜𝚌𝚊𝚛𝚊𝚟𝚎𝚕𝚑𝚘𝚜 `)
}
