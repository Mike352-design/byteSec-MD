...
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 𒄆 ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${user(who)}
...
ɴᴏɪᴛᴇ, ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 𒄆 ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${userH(who)}
𒁂
...
𒁂 ${user(m.sender)} ᴜsᴀɴᴅᴏ sᴜᴀs ʜᴀʙɪʟɪᴅᴀᴅᴇs ᴀᴅǫᴜɪʀɪᴅᴀs ᴄᴏᴍᴏ ᴜᴍ ᴇsᴘᴇᴄᴛʀᴏ ᴅᴀ ɴᴏɪᴛᴇ,
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 𒄆 ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${user(who)} 𒁂
